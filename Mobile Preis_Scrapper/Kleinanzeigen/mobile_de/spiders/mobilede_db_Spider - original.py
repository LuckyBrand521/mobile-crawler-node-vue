    ...
    def fake_response(self, response):
        ...
        for input_row in input_data:
                ...
                try:
                    ...
                    if input_row["car_model"]:
                        try:
                            ...
                            search_param_list.append(f"ms={input_row['car_brand']}%3B{input_row['car_model']}%3B%3B%3B") #ms=8800;49;;;
                        except:
            ...
            if input_row["size"]:
                if "Kombi" in input_row["size"]:
                ...
                elif "SUV" in input_row["size"] or "Sports Utility Vehicle" in input_row["size"] or "Pickup" in input_row["size"]:
                    param_list.append("categories=OffRoad")
                    search_param_list.append("c=OffRoad")
                elif "Van" in input_row["size"] or "Minibus" in input_row["size"]:
                    param_list.append("categories=Van")
                    search_param_list.append("c=Van")
                    ...
                    param_list.append("categories=OtherCar")
                    search_param_list.append("c=OtherCar")
